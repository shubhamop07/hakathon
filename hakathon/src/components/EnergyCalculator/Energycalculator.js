            ...
            <div className="container-fluid">
                <div className="calculator">
                    ...
                    <div className="input-section">
                        <label htmlFor="wattage" style={{ color: 'black' }}>Appliance Wattage (W):</label>
                        <input 
                            type="number" 
                            id="wattage" 
                            value={wattage}
                    ...
                    <div className="input-section">
                        <label htmlFor="hours" style={{ color: 'black' }}>Hours Used Per Day:</label>
                        <input 
                            type="number" 
                            id="hours" 
                            value={hours}
                    ...
                    <div className="input-section">
                        <label htmlFor="rate" style={{ color: 'black' }}>Rate per kWh (Rs):</label>
                        <input 
                            type="number" 
                            id="rate" 
                            value={rate}
                    ...
                    <div className="input-section">
                        <label htmlFor="days" style={{ color: 'black' }}>Number of Days:</label>
                        <input 
                            type="number" 
                            id="days" 
                            value={days}
